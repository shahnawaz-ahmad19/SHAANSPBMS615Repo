...
import com.shaan.controller.PayrollSystemController;
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/						      
					...
					/* listEmps.forEach(emp->{ //Java8 for each syntax1
								    	  System.out.println(emp);
								      });*/
			      
					/* listEmps.forEach(emp->       //Java8 for each syntax2
								         System.out.println(emp)
								      );*/
			      
					 listEmps.forEach(System.out::println); //java8 forEach with method refrence concept    
		}//try
