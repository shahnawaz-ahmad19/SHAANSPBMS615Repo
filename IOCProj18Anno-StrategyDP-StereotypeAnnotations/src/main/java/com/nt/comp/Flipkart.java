...
public final class Flipkart {
	...
	@Autowired
	//@Qualifier("dtdc")  // Hardcoding of dependent bean id is bad practice
//	@Qualifier(@Value("${choose.courier}"))  Will not work becoz @Qualifier does not alow @Value
	/*	@Value("${choose.courier}")
		private String cid;
		@Qualifier(cid)  we can not pass beanId as a variable name*/
	 @Qualifier("logistic")     
